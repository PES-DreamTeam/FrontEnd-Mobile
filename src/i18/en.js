const en = {
	...
	faq: {
		...
		answer2TechnicalIncidence: "f it is a technical issue of the application itself, you can access the reports section of the application, located in the side navigation bar, to report the information you see fit.",
